...
One of the fundamental aspects of Causality is the presence of an order and a context; the latter of such elements not being present in associative information; this is, consider a distribution $p(a,t)$, which we can factorize in the two following ways:
\begin{equation}
    p(a,t)=p(a|t)p(t)
\end{equation}
and
