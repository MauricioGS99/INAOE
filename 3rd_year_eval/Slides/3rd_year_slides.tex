...
\item Given the importance of Causation in science\footnote{\cite{lake2017building,pearl2018why}} \textbf{we consider decision making theory that relies on causal information.}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Rationality.
\item Decision Theory: rational decision making if and only if expected utility maximization
...
\begin{frame}
\frametitle{Causal-Structure Learning: A purely Bayesian + Random Graphs Approach}
\begin{itemize}
