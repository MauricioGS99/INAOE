...
Teoría de Juegos (\cite{von1944theory}, \cite{osborne1994course}, \cite{webb2007game}, \cite{gintis2014bounds})
\subsubsection{Aprendizaje por refuerzo como toma de decisiones}
...
\subsection{Problema}
Adquirir y utilizar información causal para mejorar el desempeño de un agente que interactua con su entorno con el fin de maximizar una recompensa a largo plazo. 
