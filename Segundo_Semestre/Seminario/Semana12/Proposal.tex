...
\end{itemize}
\indent Estos requerimientos vamos a tratarlos de manera axiomática, en el sentido de que se dan por sentado sin cuestionarlos. Quien no esté de acuerdo con los axiomas, no lo estará con las conclusiones y queda siempre la invitación de desarrollar la teoría utilizando otras altenativas.
