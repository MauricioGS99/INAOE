...
Proceeding in this way, the probability of the patient living if the assigned treatment is surgery is only $0.28$.

On the other hand, if the treatment assigned is the pill, then the living probability is $0.37$
